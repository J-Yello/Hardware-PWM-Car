...
// Initalize PB0~3 as outputs to control the H-Bridge which will allow you to control which directon the motors spin  
void Control_Int(void);

// Initalize PF1-3 for onboard LEDs 
void PortF_LEDInit(void); 

// Initializes PF0, PF4 to be swtiches 
void Switch_Init(void);

// Initializes PPL to generate 50Mhz clock 
void PLL_Init(void);
